...
var L_WeatherVideo_Text = "Vidéos sur la météo d'aujourd'hui";
var L_MoreVideo_Text = "Plus de vidéos sur la météo";
var L_ForecastVideo_Text = "Vidéos des prévisions nord-américaines";
var L_ViewAllVideo_Text = "Afficher toutes les vidéos sur la météo";
var L_NewsWeather_Text = "Actualités - Météo";
var L_NoResults_Text = "Aucun résultat n'a été trouvé.";
var L_SearchTips_Text = "Vous n'avez pas trouvé les informations recherchées ? Voici quelques conseils :";
var L_SearchTip1_Text = "Indiquer l'état ou le pays ainsi que la ville. Par exemple, {0} ou {1}. ";
var L_SearchTip1Example1_Text = "San Francisco, CA";
var L_SearchTip1Example2_Text = "Londres, Angleterre";
var L_SearchTip2_Text = "Assurez-vous de séparer la ville de l'état ou du pays avec une virgule.";
var L_Feedback_Text = "Si vous ne parvenez toujours pas à trouver ce que vous recherchez, envoyez-nous vos commentaires et nous tenterons de résoudre le problème.";
var L_TextInEng_Text = "{0}";
var L_PlayAnimation_Text = "Lire";
var L_StopAnimation_Text = "Arrêter";
...
function VideoModule(thumbs, hasRegion)
{
	...
	document.write('<a class="more" href="https://web.archive.org/web/20080905100451/http://video.msn.com/v/us/v.htm?t=c9&f=12/64&p=Weather_Forecast - Maps">'+L_ViewAllVideo_Text+'</a></div>');
}
...
function SetInitialMapSelection(index)
{
	var newSelection = document.getElementById("MR" + index);
	newSelection.className = "i3";
	currentSelection = index;
...
function LocationStr(locName)
{
    document.find.weasearchstr.value = locName;
}

function ClearText()
{
    document.find.weasearchstr.value = "";
}

// Highlight all text in Find Weather search box.
function SelectAllFindText()
{
    document.find.weasearchstr.select();
}
...
//Start: Map slide show functions
var currentDiv =0;
function SetInitialMapShow()
{
    currentDiv = -1;
    nextClick();
}
function prevClick()
{
    var parent1 = document.getElementById("slides1");
    var count = GetCount(parent1);
...
{
    var thisChild = arg.firstChild;
    var count =0;
    while ( thisChild != arg.lastChild )
	{
...
//End: Map slide show functions

}
/*
     FILE ARCHIVED ON 10:04:51 Sep 05, 2008 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 16:41:23 Sep 20, 2025.
...
playback timings (ms):
  ...
  esindex: 0.015
  cdx.remote: 28.121
  LoadShardBlock: 305.404 (3)
  PetaboxLoader3.datanode: 217.988 (4)
  PetaboxLoader3.resolve: 295.196 (2)
  load_resource: 266.935
*/