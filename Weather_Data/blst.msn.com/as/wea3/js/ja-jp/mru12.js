...
var L_WeatherVideo_Text = "MSN ビデオ";
var L_MoreVideo_Text = "もっと見る";
var L_ForecastVideo_Text = "天気予報ビデオ";
var L_ViewAllVideo_Text = "もっと見る";
var L_NewsWeather_Text = "天気関連ニュース (MSN産経ニュース)";
var L_NoResults_Text = "該当ありませんでした。";
var L_SearchTips_Text = "お探しの情報が見つからない場合、ヒントをご覧ください。";
var L_SearchTip1_Text = "市区町村名だけではなく、都道府県名なども追加してみてください。例: {0} もしくは {1}.";
var L_SearchTip1Example1_Text = "東京都 調布市";
var L_SearchTip1Example2_Text = "ワシントン州 シアトル";
var L_SearchTip2_Text = "市区町村と都道府県名がカンマで区切られていることをご確認ください。";
var L_Feedback_Text = "お探しのページが見つからない場合にはお問い合わせください。";
var L_TextInEng_Text = "{0}";
var L_PlayAnimation_Text = "再生";
var L_StopAnimation_Text = "停止";
...
function VideoModule(thumbs, hasRegion)
{
	...
	document.write('<a class="more" href="https://web.archive.org/web/20130118092051/http://video.msn.com/v/us/v.htm?t=c9&f=12/64&p=Weather_Forecast - Maps">'+L_ViewAllVideo_Text+'</a></div>');
}
...
/*
     FILE ARCHIVED ON 09:20:51 Jan 18, 2013 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 16:41:37 Sep 20, 2025.
...
playback timings (ms):
  ...
  PetaboxLoader3.datanode: 92.738 (4)
  PetaboxLoader3.resolve: 74.29 (2)
  load_resource: 119.505
*/